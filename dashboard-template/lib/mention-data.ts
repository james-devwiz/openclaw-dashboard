...
const SKILLS = items("Skills", [
  ...
  ["content-writer", "Write posts, captions, blog articles with tone of voice"],
  ["video-planner", "Plan video scripts — Reels, Shorts, YouTube, TikTok"],
  ["carousel-planner", "Plan carousel slides for LinkedIn and Instagram"],
  ["docx", "Generate Word documents (.docx)"],
  ["pptx", "Generate PowerPoint presentations (.pptx)"],
...
const CONTEXT = items("Context", [
  ...
  ["heartbeat", "Periodic checklist and schedule (30min)"],
